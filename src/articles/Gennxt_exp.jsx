    ...
    return(
        <>
            <div className="art-wrap">
                <h1 className="art-h1"><b>Empowering Future Leaders: <br />A Recap of the GenNxt Lab Leadership Bootcamp</b></h1>
                ...
                <ul>
                    <li>D Pavan Kumar</li>
                    <li>S Abhishek Samuel</li>
                    <li>G Sudarshan Rao</li>
                    <li>K Rahul</li>
                    <li>M Pavan</li>
                    <li>B Manikanta Srinath</li>
                    <li>B Shesank</li>
                    <li>D V S K Vijayaramaraju</li>
                    <li>M Sai Ganesh</li>
                    <li>Sunkari Sai</li>
                    <li>N Murthy</li>
                </ul>
...
<br /> <br />The day concluded with Sustainability and Leadership, guided by <i>Mr. Saravanan ,Asst. Vice President KCT</i>, who shared real-world examples from Kumaraguru College of Technology (KCT). He discussed initiatives such as paper conservation and waste management, demonstrating how sustainability is vital in modern leadership. Participants were inspired to incorporate eco-conscious practices in their future workplaces.


</p>
<br />
<h2 className="art-h2">Day 2: Leadership, Problem-Solving, and Innovation</h2>

<p className="art-p">Day 2 began with the Protect the Egg Challenge, a team-building exercise where participants had to construct a structure to protect an egg dropped from a height. This hands-on activity revealed group dynamics and natural leadership styles, giving participants insights into how teams function under pressure.
<br /><br />
...
<br /><br />
From the excitement of the Protect the Egg Challenge to the deep self-reflections on emotional intelligence, participants walked away with not only new skills but cherished memories of teamwork, problem-solving, and mutual support. The energy, creativity, and camaraderie that filled each session will remain with the participants as they move forward in their leadership journeys. 
<br /><br />
